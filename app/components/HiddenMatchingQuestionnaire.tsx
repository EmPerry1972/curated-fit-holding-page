...
function ClientQuestionnaire() {
  ...
  return <Frame><p style={styles.eyebrow}>Internal Phase A questionnaire</p><h1 style={styles.heading}>Client matching test</h1><p style={styles.body}>Submitting this form calculates and stores internal match rankings in Airtable. It does not show or assign matches, create introductions, send email or notify anyone.</p><form onSubmit={submit}>
