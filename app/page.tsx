          ...
          <form onSubmit={submit} noValidate style={{ marginTop: 36, display: "grid", gap: 22 }}>
            ...
            <fieldset style={{ border: 0, display: "grid", gap: 18 }}>
              ...
              <div data-field="photo">
                ...
                {photoUploading && <p style={{ fontSize: 13, color: "var(--muted)", marginTop: 8 }}>UploadingÃ¢ÂÂ¦</p>}
            ...
            <div>
              <button type="submit" disabled={submitting || photoUploading} style={{ ...cta, opacity: submitting || photoUploading ? 0.6 : 1 }}>
                {submitting ? "SubmittingÃ¢ÂÂ¦" : "Apply to Curated Fit"}
              </button>
            </div>
          </form>
        </div>
        ...
        <div style={wrap}>
          ...
          <div style={{ marginTop: 24 }}>
            <details style={{ borderTop: "1px solid var(--line)", padding: "18px 0" }}>
              ...
              <p style={{ ...body, marginTop: 12 }}>There is no joining fee or monthly listing fee during the Curated Fit launch stage. Any future commercial changes will be communicated clearly before they take effect.</p>
            </details>
            <details style={{ borderTop: "1px solid var(--line)", padding: "18px 0" }}>
