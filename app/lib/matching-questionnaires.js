...
export function validateClientSubmission(data, { requireContact = true } = {}) {
  const errors = {};
  if (requireContact) {
...
const onlineSelected = Array.isArray(data?.preferredSettings) && data.preferredSettings.includes("SET-06");
    if (!onlineSelected) {
